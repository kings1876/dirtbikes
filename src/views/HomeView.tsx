  ...
  return (
    <div className="space-y-16 pb-16">
      ...
      <section className="relative overflow-hidden rounded-3xl bg-zinc-950 border border-zinc-800/80 mx-4 sm:mx-6 lg:mx-8 mt-4">
        {/* Decorative backdrop: dot grid + radial glow (no full-bleed photo, since our product shots are studio cutouts) */}
        <div className="absolute inset-0 z-0 pointer-events-none">
          <div className="absolute inset-0 bg-[radial-gradient(#10b981_1px,transparent_1px)] [background-size:22px_22px] opacity-[0.07]" />
          <div className="absolute -right-24 top-1/2 -translate-y-1/2 w-[560px] h-[560px] rounded-full bg-emerald-500/10 blur-3xl" />
        </div>

        <div className="relative z-10 flex flex-col lg:flex-row items-center gap-4 lg:gap-8 px-6 sm:px-12 py-12 sm:py-16">
          {/* Copy Column */}
          ...
          {/* Featured Bike Column */}
          <div className="relative flex-1 w-full flex justify-center lg:justify-end">
            <div className="absolute w-[85%] aspect-square rounded-full bg-emerald-500/15 blur-3xl" />
            <div className="relative w-full max-w-[280px] sm:max-w-sm lg:max-w-md rounded-[2rem] bg-gradient-to-b from-zinc-100 via-white to-zinc-200 p-5 sm:p-7 shadow-2xl ring-1 ring-white/10">
              <img
                src="/images/products/surron-light-bee-x.jpg"
                alt="Surron Light Bee X Electric Dirt Bike"
                className="w-full h-full object-contain"
              />
              <span className="absolute -top-3 left-1/2 -translate-x-1/2 px-3 py-1 rounded-full text-[11px] font-mono font-black bg-emerald-500 text-zinc-950 uppercase tracking-wide shadow-lg whitespace-nowrap">
                Surron Light Bee X
              </span>
            </div>
          </div>
