              ...
              >
                ...
                <div className="absolute inset-0 z-0 bg-zinc-950">
                  <img
                    ...
                    alt=""
                    aria-hidden="true"
                    className={`w-full h-full object-cover opacity-65 group-hover:opacity-75 transition-opacity duration-300 filter contrast-125 ${CATEGORY_IMAGE_POSITION[cat.name] || 'object-center'}`}
                  />
